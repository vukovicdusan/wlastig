...
const Reel = () => {
	...
	return (
		<Region bottomPadding={"0"}>
			<div className={styles.reel}>
				<div className={styles.reelLinks}>
					<button
						onClick={() => reelLinkHandler(0)}
						className={styles.reelButton}
					>
						<span className={styles.reelLinkIcon}>
							<Image
								src={reelLink1}
								height={70}
								width={70}
					...
					<div className={styles.reelItem}>
						<div className={styles.reelItemContent}>
							...
							<p>
								...
								state-of-the-art advertising methods which
					...
					<div className={styles.reelItem}>
						<div className={styles.reelItemContent}>
							...
							<p>
								...
								we&quot;ll be there to promptly steer the way
								towards solution.
							</p>
						</div>
					</div>
